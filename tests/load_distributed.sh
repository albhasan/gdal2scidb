...
find /disks/d7/sdb_chunks -type f | grep "mod13q1_h"$H"v"$V"_" | sort | head -n $FIRST > fileslist.txt
parallel --eta --jobs 1 -n $SDB_INSTANCES --arg-file fileslist.txt bash load_parallel.sh 
