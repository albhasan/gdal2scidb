...
echo "Exporting images' pixels..."
python /home/scidb/ghProjects/gdal2scidb/gdal2bin_chunk.py --log info --d2tid False --output csv --d2att True --tile2id false 0 0 1 1 0 0 $(find /home/scidb/LANDSAT/landsat8Original/SurfaceReflectanceC1 -type f | grep "LC08_L1GT_226064_[0-9]\{8\}_[0-9]\{8\}_01_T2_sr_[+a-z|+A-Z].*\.tif$" | sort | head -n 33) > /tmp/gdal2scidb_data
...
python /home/scidb/ghProjects/gdal2scidb/gdal2bin_chunk.py --log info --d2tid False --d2att True --output binary --tile2id false 0 0 1 1 0 0 $(find /home/scidb/LANDSAT/landsat8Original/SurfaceReflectanceC1 -type f | grep "LC08_L1GT_226064_[0-9]\{8\}_[0-9]\{8\}_01_T2_sr_[+a-z|+A-Z].*\.tif$" | sort | head -n 33) > /tmp/gdal2scidb_data
