...
OUT_DIR=/home/scidb/sdb_chunks/myd13q1_h"$H"v"$V"    # Where to store the chunk binaries
...
FILES=$(find -L /home/scidb/MYD13Q1 -type f | grep "MYD13Q1\.A[0-9]\{7\}\.h"$H"v"$V"\.006\.[0-9]\{13\}\.hdf$" | sort | head -n $FIRST)
